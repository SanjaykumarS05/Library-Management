...
class BookIssueController extends Controller
{
    ...
    public function issueBook(Request $request)
    {
        ...
        return redirect()->route('staff.barcode.index')->with('success', 'Book issued successfully!');
    }
    ...
    public function returnBook(Request $request)
    {
        ...
        $overdue= Book_issue::where('id', $request->issue_id)
            ...
            ->get();
        if ($overdue->count() > 0) {
            return view('staff.overdue', compact('overdue'));
        }
        ...
        return redirect()->route('staff.barcode.index')->with('success', 'Book returned successfully!');
    }
    ...
    public function issueReturn($bookId = null, $userId = null)
    {
        ...
        return view('staff.issue_return', compact('users', 'books', 'book_issues1', 'selectedBook', 'selectedUser'));
    }
