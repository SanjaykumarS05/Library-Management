...
class BarcodeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('staff.barcode', compact('barcodes', 'book_issues_count'));
    }
    ...
    public function getBookInfo($barcode)
    {
        ...
        if (!$book_issue) {
            return redirect()->route('staff.barcode.index')->with('error', 'Book not found for the provided barcode.');
        }
        ...
        return view('staff.barcode_info', compact('book_issue', 'bookData', 'users'));
    }
}
