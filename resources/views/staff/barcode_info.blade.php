...
<div class="container">
    <center>
        ...
        @else
            <form action="{{ route('staff.book.issue') }}" method="POST" style="margin-top:15px;">
                @csrf
        ...
        @endif
        <br>
        <a href="{{ route('staff.barcode.index') }}" class="buttons" style="background-color:#2196F3;">Back to Scanner</a>
    </center>
</div>
@endsection
